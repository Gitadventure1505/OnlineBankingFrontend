...
@Component({
  selector: 'app-transfercash',
  templateUrl: './transfercash.component.html',
  styleUrls: ['./transfercash.component.css']
})
export class TransfercashComponent implements OnInit {
  ...
  @Input() ToAccountNumberFormControl: any
  ...
  ngOnInit(): void {
    ...
    this.ToAccountNumberFormControl = new FormControl('', [Validators.required]);
  ...
  transferMoney() {
    ...
    this.transaction.fromaccount = this.AccountNum;
    this.transaction.accountnum = this.AccountNum;
    //this.transaction.toaccount = this.toaccount;
